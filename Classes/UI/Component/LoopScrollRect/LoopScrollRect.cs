...
{
    public interface ILoopScrollRectDataSource
    {
        RectTransform CreateScrollCell(int itemIdx);
        object GetData(int itemIdx);
        int TotalCount { get; }
    }
    ...
    {
        private ILoopScrollRectDataSource m_dataSource;
        /// <summary>
        /// 
        /// </summary>
        public ILoopScrollRectDataSource DataSource
        {
            get { return m_dataSource; }
            set { m_dataSource = value; }
        }
        //==========LoopScrollRect==========
        protected float m_detalSizeToCreateItem = 1.0f;
        public float DetalSizeToCreateItem
        {
            get { return m_detalSizeToCreateItem; }
            set { m_detalSizeToCreateItem = Math.Max(1.0f, value); }
        }
        ...
        private void SendMessageToNewObject(Transform go, int idx)
        {
            ...
            {
                object o = DataSource.GetData(idx);
                if(o != null)
                {
                    go.SendMessage("ScrollCellContent", DataSource.GetData(idx), SendMessageOptions.DontRequireReceiver);
                }
            }
        }
        ...
        private RectTransform InstantiateNextItem(int itemIdx)
        {
            ...
            RectTransform nextItem = DataSource.CreateScrollCell(itemIdx);
